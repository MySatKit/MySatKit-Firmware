  ...
  <style>
    ...
    * {
    ...
    @keyframes cubeRotation {
      0% {
        transform: rotateY(0deg) rotateX(187.2deg) rotateZ(178.2deg);
      }

      100% {
        transform: rotateY(359.9deg) rotateX(187.2deg) rotateZ(178.2deg);
      }
    }
                  ...
                  <svg id="sunSvg" viewBox="-120 -120 240 240" style="width:80%;margin-left:10%;display:block;">
                    <defs>
                      ...
                      <radialGradient id="g1">
                        ...
                        <stop id="g1s" offset="100%" stop-color="gray" />
                      </radialGradient>
                      <radialGradient id="g2">
                        <stop offset="0%" stop-color="white" />
                        <stop id="g2s" offset="100%" stop-color="gray" />
                      </radialGradient>
                      <radialGradient id="g3">
                        <stop offset="0%" stop-color="white" />
                        <stop id="g3s" offset="100%" stop-color="gray" />
                      </radialGradient>
                      <radialGradient id="g4">
                        <stop offset="0%" stop-color="white" />
                        <stop id="g4s" offset="100%" stop-color="gray" />
                      </radialGradient>
